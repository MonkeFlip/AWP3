...
int main()
{
    ...
    float* output_matrix_GPU = new float[in_matrix_M * out_matrix_M * M];
    ...
    ClearMatrix(output_matrix_GPU, in_matrix_N, out_matrix_M, M);
    float time = 0;
    float* GPU_elapsedTime = &time;
    kernel(input_matrix, output_matrix_GPU, in_matrix_N, in_matrix_M, out_matrix_M, M, GPU_elapsedTime);
    ...
    if (CompareMatrices(output_matrix, output_matrix_GPU, in_matrix_N * out_matrix_M * M))
    {
